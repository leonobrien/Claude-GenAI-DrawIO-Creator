 ...
 */
function extractVertexIds(xml: string): Set<string> {
 ...
 */
function extractEdges(xml: string): Array<{ id: string; source?: string; target?: string }> {
 ...
 */
function extractVertexLabels(xml: string): Map<string, string> {
...
function extractVertexStyles(xml: string): Array<{ id: string; style: string }> {
  const styles: Array<{ id: string; style: string }> = [];
 ...
 */
export function validateEdgeReferences(xml: string): SemanticValidationResult {
 ...
 */
export function validateExpectedLabels(
  xml: string,
  ...
  for (const expected of expectedLabels) {
    const found = [...existingLabels].some(
 ...
 */
export function validateNotationConformance(
  xml: string,
