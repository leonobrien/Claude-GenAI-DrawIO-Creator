...
const EDGE_RULES = [
  ...
  '- Use the notation edge style template as the base for all edges:',
  '  - AWS/GCP: "edgeStyle=orthogonalEdgeStyle;curved=1;endArrow=classic;html=1;"',
  '  - Azure/generic: "edgeStyle=orthogonalEdgeStyle;rounded=1;endArrow=classic;html=1;"',
  '  - UML/BPMN/ArchiMate: "edgeStyle=orthogonalEdgeStyle;endArrow=<type>;html=1;"',
  '  - Cisco: "endArrow=classic;html=1;" (straight lines, no edgeStyle)',
  '- Use "endArrow=none;html=1;" for undirected lines',
