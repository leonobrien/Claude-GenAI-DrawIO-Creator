 ...
 */
function extractLabelsFromXml(xml) {
    const labels = [];
 ...
 */
function extractEdgeRelationshipsFromXml(xml) {
    // Build ID -> label map
 ...
 */
export function buildIndexPayload(model, xml) {
    return {
        model_id: model.id,
 ...
 */
export function payloadToEmbeddingText(payload) {
    const parts = [];
    if (payload.name) {
...
//# sourceMappingURL=diagram-indexer.js.map