...
const EDGE_ROUTING_RULES = [
    '## Edge Routing Rules',
    '',
    '### Routing Style (edgeStyle)',
    '',
    'Each notation defines an appropriate edge routing style in its style template. Use it:',
    '- **orthogonalEdgeStyle** (most notations) -- right-angle Manhattan routing, best for structured diagrams',
    '- **orthogonalEdgeStyle;curved=1** (AWS, GCP) -- smooth curved orthogonal connectors',
    '- **orthogonalEdgeStyle;rounded=1** (generic, Azure) -- orthogonal with softened corners',
    '- **No edgeStyle / straight** (Cisco) -- direct point-to-point lines for network topologies',
    '',
    'Always include the notation edge style template as the base, then append connection-point overrides.',
    '',
    '### Connection Rules',
    '',
 ...
 */
function buildNotationSection(notation) {
 ...
 */
export function buildSystemPrompt(notation) {
    const sections = [
        ROLE_DEFINITION,
        '',
        FORMAT_RULES,
 ...
 */
export function buildRevisionPrompt(currentXml, notation) {
