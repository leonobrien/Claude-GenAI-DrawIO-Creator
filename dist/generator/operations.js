...
function applyUpdate(current, op, cellIndex) {
    if (!op.new_xml) {
...
function applyDelete(current, op, cellIndex) {
    ...
    for (const op of operations) {
        ...
        switch (op.operation) {
            ...
            case 'delete':
                ...
                break;
            default:
                result = { xml: current, error: `Unknown operation: ${op.operation}` };
        }
        current = result.xml;
        if (result.message)
